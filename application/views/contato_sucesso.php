...
<div class="container-fluid home padding-off-mobile">
    ...
    <div class="col-xs-12 col-sm-5 col-md-5 col-lg-4">
        ...
        <div class="col-xs-12 col-sm-12 col-md-12 padding-off form">
            <form>
                <div class="group-form text-center avisos-obrigado">
...
<!-- Google Code for Leads + Compra Conversion Page -->
<script type="text/javascript">
    /* <![CDATA[ */
    var google_conversion_id = 813457995;
    var google_conversion_label = "5spJCJPSwH4Qy8TxgwM";
...
<noscript>
    <div style="display:inline;">
        <img height="1" width="1" style="border-style:none;" alt="" src="//www.googleadservices.com/pagead/conversion/813457995/?label=5spJCJPSwH4Qy8TxgwM&amp;guid=ON&amp;script=0"/>
    </div>
</noscript>
